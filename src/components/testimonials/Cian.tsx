  ...
  return (
    <div className='flex flex-col gap-6 bg-[var(--color-black)] p-6'>
      ...
      <div
        ...
        style={{ paddingTop: '60%' }}
      >
        <Image src='/cian.png' alt='Cian O Driscoll' fill className='object-cover' priority />
      </div>
      ...
      <div className='flex flex-col justify-between min-h-[120px] h-full'>
        <p className='text-white/90 text-sm sm:text-base leading-relaxed mb-2'>
          “Honoured to be a judge at HackIreland at the weekend. The innovation and technical skill demonstrated by 150
          talented builders over 30 intense hours were truly impressive.”
        </p>
