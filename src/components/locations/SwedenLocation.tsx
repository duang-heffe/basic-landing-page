...
export default function SwedenLocation() {
  return (
    <div className='flex flex-col lg:mt-50'>
      <a href='https://www.norrsken.org/houses/stockholm' target='_blank' rel='noopener noreferrer' className=''>
        ...
        <div className='relative w-full' style={{ paddingTop: '80%' }}>
          <Image src='/sweden_location.png' alt='Norrsken House' fill className='object-cover' priority />
        </div>
