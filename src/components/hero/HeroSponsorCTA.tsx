  ...
  return (
    <div className='w-full max-w-md mx-auto sm:mx-0'>
      <div className='bg-[var(--color-black)] px-4 py-4 sm:px-6 sm:py-5'>
        ...
        >
          <div className="bg-white text-[var(--color-black)] px-4 py-2 sm:py-2.5 text-base sm:text-lg lg:text-[18.7px] font-normal -my-[16px] -mx-[26px] rounded-none transition-all duration-300">
            Schedule a Call
          </div>
        </StarBorder>
      </div>
