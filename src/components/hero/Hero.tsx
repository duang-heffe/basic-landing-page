...
export default function Hero() {
  return (
    <section className='w-full lg:min-h-screen bg-[var(--color-blue)] relative overflow-hidden'>
      ...
      <div className='relative z-10 w-full h-full'>
        <div className='max-w-[90rem] ml-[clamp(8%,5vw,18%)] px-4 sm:px-6 lg:px-12 py-12 sm:py-16 lg:py-[clamp(60px,8vh,80px)]'>
          {/* Text Section */}
